...
- `--pack-strategy`: packing strategy. Defaults to `ordered`; `best-fit-decreasing` reorders by length and uses a best-fit approximation to reduce padding.
